...
function capToFront(s) {
 ...
 var mayus = ""
  for (var i = 0 ; i<s.length ; i++){
    ...
    else (nuevostring=  nuevostring + s[i])
  }
nuevostring= mayus + nuevostring
return nuevostring
}
...
var invertido = [];
var normal = [];
var stringeado = "" + numero;
for(var i = 0 ; i<stringeado.length ; i++){
  invertido.unshift(stringeado[i])
  normal.push(stringeado[i]);
}
if (invertido.join("") === normal.join("")){
  return "Es capicua"
}
else {
